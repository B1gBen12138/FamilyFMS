            ...
            <table width="98%" border="0" cellspacing="0" cellpadding="0">
                <tr align="left" class="bg03">
                    <td width="100%" height="29">
                        <span class="text001">&nbsp;&nbsp;修改流水管理管理信息</span></td>
                </tr>
            </table>
            <form id="subform" action="update" method="post">
                <table width="98%" border="0" cellpadding="0" cellspacing="0" class="text008">
                    <tr align="center">
                        <td width="12%" height="35" align="right">ID</td>
                        <td width="88%" align="left">
                            <label for="id">
                                <input id="id" name="id" readonly="readonly" type="text" class="inp001" value="${bondIOList.id}"
                                       >
                            </label>
                        </td>
                    ...
                    <tr align="center">
                        <td width="12%" height="35" align="right">证券</td>
                        <td width="12%" align="left" style="width: 20%">
                            <label for="bondListId">
                                <input id="bondListId" name="bondListId" readonly="readonly" type="text" class="inp002" value="${bondIOList.bondListId}">
                            </label>
                        </td>
                    <tr align="center">
